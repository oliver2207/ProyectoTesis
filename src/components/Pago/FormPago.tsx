...
function FormPago() {
  return (
    <main className="lg:flex lg:min-h-full lg:flex-row-reverse lg:overflow-hidden bg-[#d1c0a7]">
    ...
    <section
      ...
      className="flex-auto overflow-y-auto px-4 pb-16 pt-12 sm:px-6 sm:pt-16 lg:px-8 lg:pb-24 lg:pt-0 bg-slate-500"
    >
